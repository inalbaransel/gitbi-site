        ...
        >
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>
                    ...
                    >
                        Daha fazla hayatı dönüştürmek ve bu sırada sürekli gelişen bir ekip olmak için yola çıktık. Geldiğimiz nokta burada.
                    </h3>
                    ...
                    <h3 className=' text-[2vh] sm:text-[5vh] font-semibold sm:leading-[7vh]'>
                        Gerçek insanlar — gerçek hayat deneyimleri — Ürünlerimizi ve çözümlerimizi bu temelde inşa ettik.
                    </h3>    
                </div>
                <div 
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>
                    ...
                    >
                        Ekibimiz küresel ve çeşitli; çünkü bireysel deneyimlerimiz bizi daha güçlü kılıyor.
                    </h3>
                    <h1 className=' font-semibold text-[10vh] sm:text-[20vh] leading-none text-pink-700'>
                        49%
                    </h1>
                    <h3 className='text-[3.5vh] whitespace-nowrap sm:text-[6vh] font-semibold sm:leading-[6vh]'>
                        Yazılım Dünyasının Öncü Kadınları.
                    </h3>    
                </div>
                <div 
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>                   
                    ...
                    <h3 className='text-[3.1vh] leading-[3.4vh] sm:text-[6vh] font-semibold sm:leading-[8vh]'>
                        Ekibimizi Oluşturan Global <br/> Renkler.
                    </h3>    
                </div>
                <div 
