...
const data = [
    {key: 1, title: "Ege Bozkurt", role: "Yönetici", img: img1},
    {key: 2, title: "Hüseyin ", role: "Yönetici", img: img2},
    {key: 3, title: "Baransel Inal", role: "Full-Stack Dev.", img: img3},
    {key: 4, title: "BugraBG", role: "Yönetici"},
    {key: 5, title: "Ahmet Bera Pehlivan", role: "Yönetici"},
    {key: 6, title: "Elvenaz", role: "Yönetici"},
    {key: 7, title: "Emre", role: "Yönetici"},
    {key: 8, title: "Esin Nisa", role: "Yönetici"},
    {key: 9, title: "Dila", role: "Yönetici"},
]
      ...
      {data.map((item, index) => {
        return (
          ...
          >
            ...
            <div className="hidden sm:inline-block bluelayer sm:absolute top-0 left-0 z-[2] w-full h-0 bg-sky-400"></div>
          </div>
        )
      })}
    </div>
