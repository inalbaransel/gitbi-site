  ...
  return (
    ...
    >
        <div className="ltext sm:sticky sm:top-[10%] left-0 sm:w-1/2 ">
            ...
            >
                Teknolojinin, karmaşık süreçleri basitleştirerek kullanıcıyı merkeze alacağına inanıyoruz. İnsan odaklı yazılım çözümleriyle kapasiteyi hızlandırıyor ve sonuçları iyileştiriyoruz.
            </p>
            <h1 className="texthead font-[SansitaReg] text-[5vh] leading-[6vh] sm:text-[9.8vh] sm:leading-[12vh] mt-10 mb-10">Kullanıcı Odaklı Dijital Deneyimler Üretiyoruz.</h1>
            {/* button */}
            <Button  bgColor="bg-none" text="ÇÖZÜMLERİMİZ" />
        </div>
        <div
            ref={container} 
